...
ToplevelWindow::ToplevelWindow(int                width,
                               int                height,
...
void DrawTextbox(PixelWriter & writer, Vector2D<int> pos, Vector2D<int> size) {
    ...
    // fill main box
    fill_rect(pos + Vector2D<int>{1, 1}, size - Vector2D<int>{2, 2}, 0xffffffff);

    // draw border lines
    fill_rect(pos,                            {size.x, 1}, 0x84848484);
    fill_rect(pos,                            {1, size.y}, 0x84848484);
    fill_rect(pos + Vector2D<int>{0, size.y}, {size.x, 1}, 0xc6c6c6c6);
    fill_rect(pos + Vector2D<int>{size.x, 0}, {1, size.y}, 0xc6c6c6c6);
}
